...
Open `demos/tmp-forge-live.html`. Select your provider and confirm your key is loaded (see docs/attendee/first-run.md). Enable **[ ⏸ STEP MODE ]** if you want to pause between phases and read each one before continuing.
