...
**Time: ~45 minutes | Select your provider and confirm your key is loaded (see docs/attendee/first-run.md for all options); DEMO MODE is free**

---

## What This Lab Does

You're going to run two adversarial AI exercises and compare how the blue team performs across them. The COMBAT demo coordinates two swarms — a red team (attackers) and a blue team (defenders) — through a structured exercise with six phases. Each phase, red acts and blue responds.
